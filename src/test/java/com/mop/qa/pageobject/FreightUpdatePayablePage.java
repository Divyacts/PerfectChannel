...
public class FreightUpdatePayablePage extends PageBase {

	protected FreightUpdatePayablePage(RemoteWebDriver remoteWebDriver) {
	...
	@FindBy(xpath = "//input[@name='Select2']")
	private WebElement businessUnitCheckBox;

	@FindBy(xpath = "//img[@name='hc952']")
	private WebElement deletingButton;

	@FindBy(xpath = "//select[@name='RightOperand2']")
	private WebElement selectRightBox2;
	...
	public void workWithFreightUpdatePayablePage() throws IOException {
		...
		try {
			...
			selectOPtionByVisibleText(selectRightBox2, "Literal");
