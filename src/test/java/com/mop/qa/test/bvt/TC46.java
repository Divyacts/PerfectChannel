...
public class TC46 extends TestBase {
	...
	public void executeTest() {
		try {
			System.out.println("Test to perform Credit batching Post Sale Freight");
			...
			SaleBatchSubmissionPage saleBatch = jdeHomePage
					.navigateToCreditBatchingPsotSaleFrieght();
			saleBatch.submitCombineBtachingForPostSaleFreight();
