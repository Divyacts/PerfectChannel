...
public class TC52 extends TestBase {
	...
	public void executeTest() {
		try {
			System.out.println("Test to perform LedgerManagement batching Sundry And Buyer Invoice");
			...
			SaleBatchSubmissionPage saleBatch = jdeHomePage
					.navigateToCLedgerBatchingSundryInvoice();
